...
<header>
    ...
    <div class="imagen-arriba">
    	<img src="../img/banner9.png" alt="Descripción de la imagen">
    	 	<p>La oftalmología es la especialización de la medicina veterinaria que se ocupa de la salud de los ojos, del tratamiento de sus enfermedades y de la visión de los animales. En nuestro centro podemos realizar un examen oftalmológico completo a su mascota, para determinar si padece alguna enfermedad y cuál es el mejor tratamiento para ella, ya sea médico o quirúrgico.</p>    	
	</div>
	<h2>Personal:</h2>
...
for (Personal cur : lst) {
    if ("Oftalmología".equals(cur.getEspecialidad())) {
        out.print("<tr>");
