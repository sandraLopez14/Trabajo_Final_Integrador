...
<header>
    ...
    <div class="imagen-arriba">
    	<img src="../img/banner7.png" alt="Descripción de la imagen">
    	 	<p>La cardiología veterinaria estudia el sistema cardiovascular de los animales, formado por el corazón y los diferentes vasos sanguíneos. Por ello la cardiología para perros y gatos es tan importante, dado que gracias a ella se pueden detectar diferentes anomalías relacionadas con el sistema cardiovascular.</p>    	
	</div>
	<h2>Personal:</h2>
...
for (Personal cur : lst) {
    if ("Cardiología".equals(cur.getEspecialidad())) {
        out.print("<tr>");
