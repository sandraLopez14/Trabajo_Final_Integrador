...
<header>
    ...
    <div class="imagen-arriba">
    	<img src="../img/banner10.png" alt="Descripción de la imagen">
    	 	<p>Es la rama de la medicina veterinaria que se dedica al estudio de las patologías que afectan a los sistemas nerviosos central (encéfalo y médula espinal) y periférico (nervio, músculo y unión neuromuscular). En el caso de pacientes con sintomatología neurológica es imprescindible realizar en consulta una correcta evaluación y un examen neurológico apropiado, para poder establecer el diagnóstico diferencial. Este diagnóstico diferencial es el que determinará la realización de las pruebas complementarias que permitirán a nuestros neurólogos veterinarios llegar al diagnóstico definitivo</p>    	
	</div>
	<h2>Personal:</h2>
...
for (Personal cur : lst) {
    if ("Neurología".equals(cur.getEspecialidad())) {
        out.print("<tr>");
