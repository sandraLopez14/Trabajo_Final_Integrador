...
<header>
    ...
    <div class="imagen-arriba">
    	<img src="../img/banner5.png" alt="Descripción de la imagen">
    	 	<p>Es una especialidad, que tiene como objetivo identificar y tratar enfermedades en la cavidad oral de las mascotas. La higiene bucal no es exclusiva del ser humano. Si cuidamos todos los días de nuestra boca ¿por qué no hacemos lo mismo con nuestras mascotas?. La boca del animal es la cavidad del cuerpo que más está expuesta a las bacterias y a los virus.</p>    	
	</div>
	<h2>Personal:</h2>
...
for (Personal cur : lst) {
    if ("Odontología".equals(cur.getEspecialidad())) {
        out.print("<tr>");
