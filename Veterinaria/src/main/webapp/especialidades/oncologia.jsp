...
<header>
    ...
    <div class="imagen-arriba">
    	<img src="../img/banner12.png" alt="Descripción de la imagen">
    	 	<p>La oncología veterinaria se destaca como una especialidad en crecimiento en la actualidad, debido al aumento de las investigaciones, enseñanza y extensión en las universidades, así como con el aumento de los recursos disponibles en las clínicas y hospitales veterinarios, que han ampliado las opciones de diagnósticos y tratamiento del cáncer en animales de compañía.</p>    	
	</div>
	<h2>Personal:</h2>
...
for (Personal cur : lst) {
    if ("Oncología".equals(cur.getEspecialidad())) {
        out.print("<tr>");
