...
<header>
    ...
    <div class="imagen-arriba">
    	<img src="../img/banner6.png" alt="Descripción de la imagen">
    	 	<p>La cirugía general o de tejidos blandos es la medicina veterinaria que se ocupa del tratamiento quirúrgico de patologías que afectan a órganos internos, piel y musculatura de los animales. En cada caso, es imprescindible llevar a cabo la técnica quirúrgica más adecuada por parte de un equipo veterinario profesional experimentado, así como contar con un quirófano bien equipado y disponer de los fármacos adecuados para llevar a cabo una anestesia segura y una correcta analgesia.</p>    	
	</div>
	<h2>Personal:</h2>
...
for (Personal cur : lst) {
    if ("Cirugía".equals(cur.getEspecialidad())) {
        out.print("<tr>");
