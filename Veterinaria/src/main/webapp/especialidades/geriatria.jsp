...
<header>
    ...
    <div class="imagen-arriba">
    	<img src="../img/banner2.png" alt="Descripción de la imagen">
    	<p>La geriatría es una rama de la medicina que estudia los trastornos que amenazan al animal de avanzada edad. Algunas de las alteraciones que se presentan en los perros viejos: obesidad, insuficiencia renal, enfermedades cardíacas, trastornos gastrointestinales y cáncer.</p>    	
	</div>
	<h2>Personal:</h2>
...
for (Personal cur : lst) {
    if ("Geriatría".equals(cur.getEspecialidad())) {
        out.print("<tr>");
