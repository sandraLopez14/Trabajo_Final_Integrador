...
<header>
    ...
    <div class="imagen-arriba">
    	<img src="../img/banner3.png" alt="Descripción de la imagen">
    	<p>La dermatología veterinaria es la disciplina que diagnostica y trata las patologías de la piel en los animales. Estos problemas dérmicos se pueden manifestar en forma de picazón, quemaduras en las almohadillas, infecciones en las orejas, erupciones cutáneas, enrojecimiento, etc.</p>    	
	</div>
	<h2>Personal:</h2>
...
for (Personal cur : lst) {
    if ("Dermatología".equals(cur.getEspecialidad())) {
        out.print("<tr>");
