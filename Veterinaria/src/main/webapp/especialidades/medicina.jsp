...
<header>
    ...
    <div class="imagen-arriba">
    	<img src="../img/banner.png" alt="Descripción de la imagen">
    	<p>La Medicina General veterinaria se encarga de velar por la salud de nuestros animales de compañía. Esta rama engloba consultas relacionadas con diferentes patologías, chequeos y planes rutinarios preventivos. Asimismo, se lleva a cabo la identificación animal, emisión de pasaportes y certificados médicos.</p>    	
	</div>
	<h2>Personal:</h2>
